...
<div class="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-4 py-2 flex justify-between items-center sm:rounded-b-[40px] shadow-[0_-4px_12px_rgba(0,0,0,0.04)] z-30 flex-shrink-0">
  ...
  <!-- Explore -->
  <a href="{{ route('events.index') }}" class="flex flex-col items-center justify-center w-14 py-1 {{ Route::is('explore') ? 'text-[#008080] font-bold' : 'text-gray-400 hover:text-gray-600' }}">
  ...
  <div class="relative -top-5 flex flex-col items-center">
    <a href="{{ route('events.create.step1') }}" class="w-14 h-14 bg-[#FF6347] rounded-full flex items-center justify-center text-white border-4 border-white shadow-lg shadow-orange-500/30 active:scale-95 transition-transform">
