...
<body class="flex justify-center items-center min-h-screen bg-gray-100 p-0 sm:p-4">
  ...
  <div class="w-full max-w-[412px] bg-[#FFFBF3] h-screen sm:h-[840px] shadow-2xl relative flex flex-col justify-between overflow-hidden sm:rounded-[40px] p-6 pt-12 pb-8">
  ...
  <script>
    function toggleButton() {
      ...
      if (checkbox.checked) {
        // チェックが入ったらボタンをアクティブ（赤オレンジのアクセントカラー）に
        btn.disabled = false;
