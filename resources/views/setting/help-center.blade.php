    ...
    <div class="flex-1 overflow-y-auto no-scrollbar p-5 space-y-6 pb-28">
      ...
      <div class="space-y-3">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100/50 overflow-hidden divide-y divide-gray-50">
          ...
          <!-- Q1 -->
          <details class="group p-4.5 [&_summary::-webkit-details-marker]:hidden cursor-pointer">
            <summary class="flex justify-between items-center text-sm font-bold text-slate-800">
              <span class="flex items-center gap-2.5">
                <i class="fa-solid fa-circle-question text-[#008080] text-base"></i>
            ...
            <p class="text-xs text-slate-600 leading-relaxed pt-3 pl-7 border-t border-gray-50 mt-3 font-medium">
      ...
      <!-- お問い合わせカード -->
      <div class="bg-white rounded-3xl p-5 shadow-sm border border-gray-100/50 space-y-3.5 text-center">
        <div class="w-11 h-11 bg-teal-50 text-[#008080] rounded-2xl flex items-center justify-center mx-auto text-lg">
          <i class="fa-solid fa-headset"></i>
        </div>
        <div class="space-y-1">
          <h3 class="text-sm font-bold text-slate-800">{{ __('messages.help.contact_us') }}</h3>
          <p class="text-xs text-gray-400 leading-relaxed font-medium">
            {{ __('messages.help.contact_desc') }}
          </p>
        </div>
        <a href="mailto:support@cebutra.com" class="inline-block w-full py-3 bg-[#008080] text-white text-xs font-bold rounded-2xl shadow-sm hover:bg-[#0D7880] transition-colors">
